...
puts 'Recipe 1 :'
recipe1 = Recipe.create(title: 'recipe1',description:'description for recipe 1',rating:1,isfavorite:true,photo:'no-photo',user:'user 1')
...
puts 'Recipe 2 :'
recipe2 =Recipe.create(title:'recipe 2',description:'description for recipe 2',rating:2,isfavorite:false,photo:'no-photo',user:'user 2')
puts 'add ingredients '
...
puts 'Recipe 3 :'
recipe3 =Recipe.create(title:'recipe 3',description:'description for recipe 3',rating:3,isfavorite:true,photo:'no-photo',user:'user 3')
puts 'add ingredients '
...
puts 'Recipe 4 :'
recipe4 =Recipe.create(title:'recipe 4',description:'description for recipe 4',rating:4,isfavorite:false,photo:'no-photo',user:'user 4')
puts 'add ingredients '
...
puts 'Recipe 5 :'
recipe5 =Recipe.create(title:'recipe 5',description:'description for recipe 5',rating:5,isfavorite:true,photo:'no-photo',user:'user 5')
puts 'add ingredients '
...
puts 'Recipe 6 :'
recipe6 =Recipe.create(title:'recipe 6',description:'description for recipe 6',rating:1,isfavorite:false,photo:'no-photo',user:'user 6')
puts 'add ingredients '
...
puts 'Recipe 7 :'
recipe7 =Recipe.create(title:'recipe 7',description:'description for recipe 7',rating:2,isfavorite:true,photo:'no-photo',user:'user 7')
puts 'add ingredients '
...
puts 'Recipe 8 :'
recipe8 =Recipe.create(title:'recipe 8',description:'description for recipe 8',rating:3,isfavorite:false,photo:'no-photo',user:'user 8')
puts 'add ingredients '
...
puts 'Recipe 9 :'
recipe9 =Recipe.create(title:'recipe 9',description:'description for recipe 9',rating:4,isfavorite:true,photo:'no-photo',user:'user 9')
puts 'add ingredients '
...
puts 'Recipe 10 :'
recipe10 =Recipe.create(title:'recipe 10',description:'description for recipe 10',rating:5,isfavorite:false,photo:'no-photo',user:'user 10')
puts 'add ingredients '
